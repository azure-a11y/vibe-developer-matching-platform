    ...
    <main id="main">
      <div className="wrap" style={{ padding: '60px 32px 100px', maxWidth: 776 }}>
        ...
        <p style={{ color: 'var(--muted)', marginTop: 16 }}>
          {settings.brandName || 'AI 빌더 그룹'}은 문의 접수를 위해 회사/담당자명, 연락처, 이메일, 프로젝트 내용을
          수집합니다. 문의 폼은 pluug(외부 서비스)를 통해 접수되며, 개인정보는 pluug에 위탁 처리됩니다. 수집한
          정보는 상담·견적 목적으로만 사용하며, 목적 달성 후 관계 법령에 따라 보관 후 파기합니다.
        </p>
        {settings.companyName ? (
          <p style={{ color: 'var(--muted)', marginTop: 16 }}>
            상호 {settings.companyName}
            {settings.ceoName && ` · 대표 ${settings.ceoName}`}
