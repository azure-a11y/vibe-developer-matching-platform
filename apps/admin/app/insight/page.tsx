  ...
  return (
    <div className="space-y-8">
      <header className="flex items-end justify-between">
        ...
        <Link href="/seo" className="text-sm text-[var(--color-accent)] hover:underline">
          SEO/GEO 현황 ↗
        </Link>
      </header>
              ...
              return (
                <tr key={post.slug} className="hover:bg-neutral-50">
                  <td className="px-5 py-4">
                    <Link href={`/insight/${encodeURIComponent(post.slug)}`} className="font-medium hover:text-[var(--color-accent)]">
                      {post.title}
                    </Link>
                  ...
                  <td className="px-5 py-4 text-right">
                    <Link href={`/insight/${encodeURIComponent(post.slug)}/review`} className="text-[var(--color-accent)] hover:underline">
                      검수
                    </Link>
                  </td>
                </tr>
